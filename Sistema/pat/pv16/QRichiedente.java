...
public abstract class QRichiedente extends ElainNode {
	...
	private int pv_IDServizio_casalinghe 	= 9291;
	private int pv_IDServizio_disoccupati 	= 9296;
	//modifica 2017
    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			try {
				...
				if(pv_IDServizio==pv_IDServizio_casalinghe){
					pv_IDRiferimento_1Trimestre = 422; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
					pv_lista_IDRelazioneParentela_figli = "27514,27515,27516,27517,27518"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
					pv_lista_IDRelazioneParentela_richiedente = "27510"; 
				}else{
					pv_IDRiferimento_1Trimestre = 432; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
					pv_lista_IDRelazioneParentela_figli = "27534,27535,27536,27537,27538"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
					pv_lista_IDRelazioneParentela_richiedente = "27530"; 
				}
            ...
            for (int k = 1; k <= n_anni; k++) {
            	...
            	for (int i = 1; i <= n_record; i++) {
            		...
            		if(pv_IDServizio==pv_IDServizio_disoccupati){
