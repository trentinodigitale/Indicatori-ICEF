...
package c_elab.pat.ass11.ce; 

import it.clesius.apps2core.ElainNode;
import it.clesius.db.sql.RunawayData;
import it.clesius.evolservlet.icef.anf.PassaValoriANF11;
...
public class Assegno_precedente extends ElainNode {
	...
	private static String anno_erogazione="2009";
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append(PassaValoriANF11.getID_dichiarazioni(IDdomanda));
