 ...
 * @author g_barbieri
 */
public class C5_altri_AupA extends DefComponentiDich {

	/** C5_altri constructor */
	public C5_altri_AupA() {
	}
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
			...
			sql.append(" and ID_tp_erogazione not in('051' ,'058' ,'060', '061', '062', '103','115', '501', '505', '046', '047')");
