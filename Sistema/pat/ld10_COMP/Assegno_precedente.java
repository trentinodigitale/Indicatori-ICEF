...
public class Assegno_precedente extends ElainNode {
	private static int pat_erogazioni_anno=2009;
	private static String id_tp_erogazione="021";
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append("WHERE PAT_erogazioni.anno="+pat_erogazioni_anno+" AND PAT_erogazioni.ID_tp_erogazione='"+id_tp_erogazione+"' AND Familiari.ID_domanda= ");
