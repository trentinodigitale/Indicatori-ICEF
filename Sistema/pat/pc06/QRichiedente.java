    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
            ...
            for (int i = 1; i <= records.getRows(); i++) {
                ...
                riferimento = super.getInteger(i, 2) - 35;  //TODO generalizzare per anni successivi!! vedi PNS_tp_riferimenti
            ...
            sql.append("(497, 498, 499, 500, 501)");             //TODO generalizzare
            ...
            sql.append("WHERE PNS_assistiti.ID_relazioneParentela IN ");
            sql.append("(502, 503, 504)");             //TODO generalizzare
            sql.append(" AND PNS_assistiti.ID_domanda = ");
            sql.append(IDdomanda);
            doQuery(sql.toString());
            for (int i = 1; i <= records.getRows(); i++) {
