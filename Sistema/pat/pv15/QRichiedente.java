...
public abstract class QRichiedente extends ElainNode {
	...
	//CAMBIAMI: va cambiata ogni anno		
		...
		int pv_IDServizio = 9290;
		//SELECT ID_riferimento, riferimento FROM   PNS_tp_riferimenti	WHERE  (ID_servizio = 9290) AND (riferimento = N'1 trimestre')
		int pv_IDRiferimento_1Trimestre = 322; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
		...
		String pv_lista_IDRelazioneParentela_figli = "26914, 26915, 26916, 26917, 26918"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
		
		//SELECT * FROM R_Relazioni_parentela	WHERE (ID_servizio = 9290) AND (parentela IN (N'Richiedente'))	
		String pv_lista_IDRelazioneParentela_richiedente = "26910"; 
