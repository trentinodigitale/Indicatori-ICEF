 ...
 * @author g_barbieri
 */
public class Invalidi extends c_elab.pat.icef20.QParticolarita {
	...
	public double getValue() {
		...
		try {
			for (int i = 1; i <= records.getRows(); i++) {
				...
				double franchigia = c_elab.pat.icef20.LocalVariables.QBI * records.getDouble(i, 9);
