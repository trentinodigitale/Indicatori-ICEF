 ...
 *
 */
public class V_check1 extends QDatiVariazioneDomanda {
	...
	public double getValue() {
        ...
        try {
			...
			int anno = dataPresentazione.get(Calendar.YEAR)+1;
			...
			//inizio del beneficio (secondo anno) primo giorno del 13o mese successivo alla data di presentazione
			Calendar data_ini=(Calendar) dataPresentazione.clone();
			data_ini.add(Calendar.YEAR, 1);
