...
public abstract class QRichiedente extends ElainNode {
	...
	int pc_IDServizio = 9340;
	int pc_IDRiferimento_gennaio = 125; //vedi mese di gennaio nella tabella PNS_tp_riferimenti per il servizio in questione
	String pc_lista_IDRelazioneParentela_figli = "5271, 5272, 5273, 5274, 5275"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_parenti = "5276, 5277, 5278, 5279"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_richiedente = "5267"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
