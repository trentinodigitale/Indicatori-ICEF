...
public class PM extends ElainNode {
	...
	// VERIFICAMI: Franchigia Individuale di non dichiarabilità sul patrimonio Mobiliare fissata a 5.000 € (Art. 15 comma 3)
	double FIM = 5000.0;  
		...
		try 
		{
			...
			for (int i = 1; i <= records.getRows(); i++) 
			{
				...
				if ( ((String) records.getElement(i, 1)).equals("BAN") 
						...
						|| ((String) records.getElement(i, 1)).equals("CPP")
