...
public abstract class QTariffa extends ElainNode {
    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
            ...
            sql.append(") AND (STUD_R_tariffe.ID_luogo = '"+PassaValoriDu2015.getID_luogo(IDdomanda)+"'");
            sql.append(") AND (STUD_R_tariffe.ID_scuola = "+PassaValoriDu2015.getID_scuola(IDdomanda));
            sql.append(") AND (STUD_R_tariffe.ID_tp_scuola = "+PassaValoriDu2015.getID_tp_scuola(IDdomanda));
            sql.append(") AND (STUD_R_tariffe.ID_tp_beneficio = '"+PassaValoriDu2015.getID_tp_beneficio(IDdomanda)+"'");
            sql.append(")");
