...
public abstract class QRichiedente extends ElainNode {
	...
	int pv_IDServizio = 9270;
	int pv_IDRiferimento_1Trimestre = 191; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
	String pv_lista_IDRelazioneParentela_figli = "13854, 13855, 13856, 13857, 13858"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pv_lista_IDRelazioneParentela_richiedente = "13850"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
