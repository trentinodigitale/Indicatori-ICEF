package c_elab.pat.coltivdir21;
...
public class Contributo_versato extends QDatiDomanda {
	...
	public double getValue() {
		...
		try 
		{
			...
			double importo_IVS_esonero = records.getDouble(1, 16);
			double importo_IVS_esonero_arretrati = records.getDouble(1, 17);
			
			importo = importo_IVS + importo_IVS_233_90 + importo_IVS_160_75 + importo_IVS_arretrati + importo_IVS_233_90_arretrati + importo_IVS_160_75_arretrati - importo_IVS_esonero - importo_IVS_esonero_arretrati;
