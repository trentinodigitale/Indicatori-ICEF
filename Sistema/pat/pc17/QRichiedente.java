    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			try {
				...
				if(pc_IDServizio==Pc17_Params.pc_IDServizio_casalinghe){
					pc_IDRiferimento_gennaio = Pc17_Params.pc_casa_IDRiferimento_gennaio; 
					pc_lista_IDRelazioneParentela_figli = Pc17_Params.pc_casa_lista_IDRelazioneParentela_figli; 
					pc_lista_IDRelazioneParentela_parenti = Pc17_Params.pc_casa_lista_IDRelazioneParentela_parenti;
					pc_lista_IDRelazioneParentela_richiedente = Pc17_Params.pc_casa_lista_IDRelazioneParentela_richiedente;
				
				}else if(pc_IDServizio==Pc17_Params.pc_IDServizio_disoccupati){
					pc_IDRiferimento_gennaio = Pc17_Params.pc_dis_IDRiferimento_gennaio; 
					pc_lista_IDRelazioneParentela_figli = Pc17_Params.pc_dis_lista_IDRelazioneParentela_figli;
					pc_lista_IDRelazioneParentela_parenti = Pc17_Params.pc_dis_lista_IDRelazioneParentela_parenti;
					pc_lista_IDRelazioneParentela_richiedente = Pc17_Params.pc_dis_lista_IDRelazioneParentela_richiedente;
				}
