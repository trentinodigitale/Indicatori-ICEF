...
public abstract class QDatiStagionali extends ElainNode {
	...
	public static Integer year_1 = 2014;
	public static Integer year_2 = 2015;
	public static Integer year_3 = 2016;
	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			sql.append("INNER JOIN LAV_tp_mansioni ON LAV_stagionali.ID_tp_mansione = LAV_tp_mansioni.ID_tp_mansione AND  LAV_stagionali.ID_servizio = LAV_tp_mansioni.ID_servizio ");
