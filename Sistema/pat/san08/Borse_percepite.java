...
public class Borse_percepite extends ElainNode {
	...
	int anno_riferimento_PAT_erogazioni = 2006; //Attenzione, da modificare ogni anno
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append("WHERE PAT_erogazioni.anno="+anno_riferimento_PAT_erogazioni+" AND PAT_erogazioni.ID_tp_erogazione='210' AND Familiari.ID_domanda= ");
