...
public class C3_imp_ast extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
			...
			sql.append("WHERE ("+tableFamiliari+".ID_relazione_parentela = "+AutoInv20_Params.assistitoMag
					+" OR "+tableFamiliari+".ID_relazione_parentela = "+AutoInv20_Params.assistitoMin+") ");
