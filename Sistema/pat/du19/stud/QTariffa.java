...
//            sql.append("");
            ...
            Table tb=MemoryCache.getInstance().getMemoryCacheTable(this.getClass(),IDdomanda,
            		PassaValoriDu2019.getID_luogo(IDdomanda),
            		PassaValoriDu2019.getID_scuola(IDdomanda),
            		PassaValoriDu2019.getID_tp_scuola(IDdomanda),
            		PassaValoriDu2019.getID_tp_beneficio(IDdomanda));
            if(tb==null){
