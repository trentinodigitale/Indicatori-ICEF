package c_elab.pat.interStrao20;
...
public abstract class QInterStrao extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			sql = new StringBuffer();
			//              							1                          2                         				3						 4						5					6
			sql.append("SELECT     tp_invalidita.coeff_invalidita, Familiari.spese_invalidita, R_Relazioni_parentela.peso_reddito, Familiari.ID_dichiarazione, IS_Familiari.spese_rsa,tp_invalidita.coeff_invalidita2016,doc.data_presentazione   ");
