...
public class Borse_percepite extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append("WHERE PAT_erogazioni.anno="+anno_erogazione+" AND PAT_erogazioni.ID_tp_erogazione='"+tp_erogazione+"' AND Familiari.ID_domanda= ");
		sql.append(IDdomanda);
