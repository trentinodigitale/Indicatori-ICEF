...
public class Figli extends ElainNode {
	...
	public Figli() {
		...
		datarif.set(2013, 5, 11, 23, 59); // 11 giugno 2013
	}
	...
	public void init(RunawayData dataTransfer) {
		...
		calcolaFigli = PassaValoriDu2012.isCalcolaFigli(IDdomanda);
		if(calcolaFigli)
		{
	...
	public void getFamiliariFromSql(String IDdomanda) {
		...
		//								6						  		7					 		8			  		  9	                    10			
		sb.append("doc_domanda.data_presentazione, doc_domanda.data_sottoscrizione, doc_domanda.id_tp_stato, doc_domanda.crc, STUD_Studenti.ID_tp_scuola ");
