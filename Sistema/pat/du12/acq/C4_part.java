...
public class C4_part extends DefComponentiDich {
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
			...
			//                             1                                     2                                         3                                4			5				                       6
			sql.append("SELECT 100 AS peso_reddito, Redditi_partecipazione.reddito_dichiarato, Redditi_partecipazione.utile_fiscale, Redditi_partecipazione.quota, ID_tp_impresa, Redditi_partecipazione.ID_dichiarazione ");
