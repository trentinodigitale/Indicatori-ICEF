...
import c_elab.pat.icef12.Usufrutto;
 ...
 * 
 */
public class QImmobiliareRenditaCatastale extends DefComponentiDich {
	...
	/** QImmobiliareRenditaCatastale constructor */
	public QImmobiliareRenditaCatastale() {
	}
	...
	protected void reset() {
		ElabContext.getInstance().resetSession( QImmobiliareRenditaCatastale.class.getName(), IDdomanda );
	}
	...
	protected String getDefaultQuery()
	{
		...
		sql.append("100 AS peso_patrimonio, Patrimoni_immobiliari.valore_ici, Patrimoni_immobiliari.ID_tp_cat_catastale, Patrimoni_immobiliari.ID_tp_diritto, Patrimoni_immobiliari.anni_usufrutto, Patrimoni_immobiliari.data_nascita_usufruttuario, Doc.data_presentazione, Dich_icef.anno_produzione_patrimoni, Dich_icef.ID_dichiarazione, Dich_icef.anno_produzione_redditi,  Patrimoni_immobiliari.ID_tp_immobile, Patrimoni_immobiliari.quota, Dich_icef.anno_attualizzato, Dich_icef.mese  ");
		...
		sql.append("AND (Patrimoni_immobiliari.ID_tp_diritto NOT IN ('NT','NV')) ");
	...
	public void init(RunawayData dataTransfer) {
		...
		ElabSession session =  ElabContext.getInstance().getSession( QImmobiliareRenditaCatastale.class.getName(), IDdomanda );
