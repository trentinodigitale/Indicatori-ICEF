 ...
 */
	...
	public static int pc_IDServizio_casalinghe 	= 9393;
//	public static int pc_IDServizio_disoccupati = 9397;
	...
	public static int pc_casa_IDRiferimento_gennaio = 18201; //CAMBIAMI - DA FARE

	public static String pc_casa_lista_IDRelazioneParentela_figli = "29944, 29945, 29946, 29947, 29948"; //vedi tabella R_Relazioni_parentela 
	public static String pc_casa_lista_IDRelazioneParentela_parenti = "29949, 29950, 29951, 29952"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	public static String pc_casa_lista_IDRelazioneParentela_richiedente = "29940"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
