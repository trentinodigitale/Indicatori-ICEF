...
public class C4_part extends DefComponentiDich {
	...
	protected Hashtable<String,Double[]> table_spese;
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
			...
			//                             1                                     2                                         3                                4							5				6										7
			sql.append("SELECT R_Relazioni_parentela.peso_reddito, Redditi_partecipazione.reddito_dichiarato, Redditi_partecipazione.utile_fiscale, Redditi_partecipazione.quota, ID_tp_impresa,Redditi_partecipazione.ID_dichiarazione ,Familiari.id_tp_invalidita ");
