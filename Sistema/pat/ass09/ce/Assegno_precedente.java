...
package c_elab.pat.ass09.ce; 

import it.clesius.apps2core.ElainNode;
import it.clesius.db.sql.RunawayData;
import it.clesius.evolservlet.icef.anf.PassaValoriANF09;
...
public class Assegno_precedente extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append("WHERE PAT_erogazioni.anno=2007 AND (PAT_erogazioni.ID_tp_erogazione='008' OR PAT_erogazioni.ID_tp_erogazione='019') AND (Redditi_altri.ID_tp_erogazione='008' OR Redditi_altri.ID_tp_erogazione='019') AND Familiari.ID_domanda= ");
		sql.append(IDdomanda);
		sql.append(" AND Familiari.ID_dichiarazione in ");
		sql.append(PassaValoriANF09.getID_dichiarazioni(IDdomanda));
