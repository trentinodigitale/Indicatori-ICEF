...
public class C4_part_ast extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
			...
			sql.append("WHERE ("+tableFamiliari+".ID_relazione_parentela = "+AutoInv18_Params.assistitoMag
					+" OR "+tableFamiliari+".ID_relazione_parentela = "+AutoInv18_Params.assistitoMin+") ");
