	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			if(!IDdomanda.startsWith("*"))
			{
				...
				sql.append("WHERE ("+tableFamiliari+".ID_relazione_parentela = "+AutoInv18_Params.assistitoMag+" OR "+tableFamiliari+".ID_relazione_parentela = "+AutoInv18_Params.assistitoMin+") AND Domande.ID_domanda = ");
