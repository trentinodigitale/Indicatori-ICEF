...
public abstract class QRichiedente extends ElainNode {
	...
	int pv_IDServizio = 9260;
	int pv_IDRiferimento_1Trimestre = 173; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
	String pv_lista_IDRelazioneParentela_figli = "6364, 6365, 6366, 6367, 6368"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pv_lista_IDRelazioneParentela_richiedente = "6360"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
