    ...
    public double getValue() {
        try {
        	...
        	if(riconferma){
        		...
        		isee = new Double((String)(uni_dati.getElement(5, 2))).doubleValue();
        	}else if(paritario){
