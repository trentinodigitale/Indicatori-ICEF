...
public class V_check extends Q_assegno {
	...
	public double getValue() {
		...
		boolean nel_nucleo[] = c_elab.pat.Util_apapi.get_ha_requisiti_da_a(
				...
				(String) tb_richiedente_da_a.getElement(1, 2), 1, 2008, false);
		...
		// correzione check nel caso in cui la domanda sia presentata dopo il 31-12-07 
		/* tolto 30-6-08 per rendere retroattivo il calcolo
		try {
