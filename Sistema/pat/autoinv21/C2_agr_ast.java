...
public class C2_agr_ast extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
			...
			sql.append("WHERE ("+tableFamiliari+".ID_relazione_parentela = "+AutoInv21_Params.assistitoMag
					+" OR "+tableFamiliari+".ID_relazione_parentela = "+AutoInv21_Params.assistitoMin+") ");
