    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			try {
				...
				if(pc_IDServizio==Pc20_Params.pc_IDServizio_casalinghe){
					pc_IDRiferimento_gennaio = Pc20_Params.pc_casa_IDRiferimento_gennaio; 
					pc_lista_IDRelazioneParentela_figli = Pc20_Params.pc_casa_lista_IDRelazioneParentela_figli; 
					pc_lista_IDRelazioneParentela_parenti = Pc20_Params.pc_casa_lista_IDRelazioneParentela_parenti;
					pc_lista_IDRelazioneParentela_richiedente = Pc20_Params.pc_casa_lista_IDRelazioneParentela_richiedente;
