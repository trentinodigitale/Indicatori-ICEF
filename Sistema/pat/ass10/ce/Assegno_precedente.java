...
package c_elab.pat.ass10.ce; 

import it.clesius.apps2core.ElainNode;
import it.clesius.db.sql.RunawayData;
import it.clesius.evolservlet.icef.anf.PassaValoriANF10;
...
public class Assegno_precedente extends ElainNode {
	...
	private static String anno_erogazione="2008";
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append(PassaValoriANF10.getID_dichiarazioni(IDdomanda));
