...
public class Affitto_assistito extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append("WHERE (Familiari.ID_relazione_parentela = 1207 OR Familiari.ID_relazione_parentela = 1225) AND (Detrazioni.ID_tp_detrazione='CNL' OR Detrazioni.ID_tp_detrazione='IMR')  AND Familiari.ID_domanda = ");
