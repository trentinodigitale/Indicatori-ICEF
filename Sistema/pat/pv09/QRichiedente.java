...
public abstract class QRichiedente extends ElainNode {
	...
	int pv_IDServizio = 9230;
	int pv_IDRiferimento_1Trimestre = 103; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
	String pv_lista_IDRelazioneParentela_figli = "5116, 5117, 5118, 5119, 5120"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pv_lista_IDRelazioneParentela_richiedente = "5112"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
