...
public abstract class QRichiedente extends ElainNode {
	...
	int pv_IDServizio = 9250;
	int pv_IDRiferimento_1Trimestre = 148; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
	String pv_lista_IDRelazioneParentela_figli = "6044, 6045, 6046, 6047, 6048"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pv_lista_IDRelazioneParentela_richiedente = "6040"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
