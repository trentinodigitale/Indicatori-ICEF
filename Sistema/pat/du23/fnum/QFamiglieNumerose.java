...
import c_elab.pat.du23.DU_Util;
import c_elab.pat.icef.util.ElabContext;
import c_elab.pat.icef.util.ElabSession;
import c_elab.pat.icef23.C1_aut;
import c_elab.pat.icef23.C1_dip;
import c_elab.pat.icef23.C1_pens;
import c_elab.pat.icef23.C2_agr;
import c_elab.pat.icef23.C3_imp;
import c_elab.pat.icef23.C4_part;
/***************************************************************************************************/
...
public abstract class QFamiglieNumerose extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			sql.append(IDdomanda);
			sql.append(") ");
			if(PassaValoriDu2023.getID_dichiarazioni(IDdomanda)!=null)
			{
				sql.append(" AND Familiari.ID_dichiarazione IN ");
				sql.append(PassaValoriDu2023.getID_dichiarazioni(IDdomanda));
			}
