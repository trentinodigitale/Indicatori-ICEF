    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
            ...
            Table tb=MemoryCache.getInstance().getMemoryCacheTable(this.getClass(),IDdomanda,
            		PassaValoriDu2023.getID_luogo(IDdomanda),
            		PassaValoriDu2023.getID_scuola(IDdomanda),
            		PassaValoriDu2023.getID_tp_scuola(IDdomanda),
            		PassaValoriDu2023.getID_tp_beneficio(IDdomanda));
            if(tb==null){
