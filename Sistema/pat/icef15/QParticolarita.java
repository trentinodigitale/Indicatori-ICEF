	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			if(!IDdomanda.startsWith("*"))
			{
                ...
                //         6                               7                                         8
				sql.append("Doc.data_presentazione, Familiari.ID_relazione_parentela, R_Relazioni_parentela.peso_reddito ");
			...
			else
			{
				...
				sql.append(
					...
					+ " Doc.data_presentazione, 0 AS ID_relazione_parentela, 100 AS peso_reddito ");
