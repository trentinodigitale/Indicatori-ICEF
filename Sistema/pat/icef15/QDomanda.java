				...
				if(ID_tp_monogenitore==9 || ID_tp_monogenitore==1){
					...
					*/
					...
					if(ID_tp_obbligo_mantenimento!=4){
						...
						//gb 2015
						int i=1;
						//bug records.getInteger(i, 14) va in nullpointer exception!!! non correggere nonostante il comportamento sia random in conseguenza alla mancanza dell' order by sulla quesry che carica i dati
