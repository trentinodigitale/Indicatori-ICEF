...
public class Affitto_assistito extends ElainNode {
  ...
  public void init(RunawayData dataTransfer)
  {
    ...
    sql.append("WHERE (Familiari.ID_relazione_parentela = " + cura20_Params.assist1 + ") ");
    sql.append(" AND (Detrazioni.ID_tp_detrazione='CNL' OR Detrazioni.ID_tp_detrazione='IMR')  ");
