...
public class Assegno_precedente extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append("WHERE PAT_erogazioni.anno="+Pc21_Params.anno+" AND Redditi_altri.ID_tp_erogazione='"+id_tp_erogazione+"' AND PAT_erogazioni.ID_tp_erogazione='"+id_tp_erogazione+"' AND Familiari.ID_domanda= ");
