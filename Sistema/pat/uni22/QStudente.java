    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
            ...
            doQuery(
                    ...
                    + " where dom_dic_icef.ID_servizio = " + Uni22_Params.id_servizio_dic_icef + " and doc_dic_icef.crc is not null and doc_dic_icef.ID_tp_stato > 0 "
            ...
            doQuery(
                    ...
                    + " where dom_dic_icef_par.ID_servizio = " + Uni22_Params.id_servizio_dic_icef_parificato + " and doc_dic_icef_par.crc is not null and doc_dic_icef_par.ID_tp_stato > 0 "
                    + " and C_ElaOUT.node = 'ICEF10' "
                    + " and domande.id_domanda = "
                    + " " + IDdomanda + ";"
            		);
            ...
            doQuery(
            		...
            		+ "and vse.node = 'VSE' "
            		+ "and isp.node = 'ISP' "
            		+ "and dom_isee_par.ID_servizio = " + Uni22_Params.id_servizio_dom_isee_parificato + " and doc_isee_par.crc is not null and doc_isee_par.ID_tp_stato > 0; "
            		);
