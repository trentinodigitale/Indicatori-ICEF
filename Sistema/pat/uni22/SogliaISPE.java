...
public class SogliaISPE extends QStudente{
    ...
    public double getValue() {
        try {
        	...
        	double valore_sogliaISPE = 0;
        	
        	if (uni_r_parmas_valore == null){
        		valore_sogliaISPE = 0.0;
        	}else{
        		valore_sogliaISPE = new Double((String)(uni_r_parmas_valore.getElement(1, 2))).doubleValue();
        	}
        	
        	return valore_sogliaISPE;
