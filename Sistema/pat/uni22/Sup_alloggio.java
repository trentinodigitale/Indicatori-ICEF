...
public class Sup_alloggio extends QStudente{
    ...
    public double getValue() {
        try {
        	...
        	double valore_sup_alloggio = 0;
        	
        	if (uni_r_parmas_valore == null){
        		valore_sup_alloggio = 0.0;
        	}else{
        		valore_sup_alloggio = new Double((String)(uni_r_parmas_valore.getElement(1, 2))).doubleValue();
        	}
        	
        	return valore_sup_alloggio;
