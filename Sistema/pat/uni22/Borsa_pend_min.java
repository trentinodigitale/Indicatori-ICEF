...
public class Borsa_pend_min extends QStudente{
    ...
    public double getValue() {
        try {
        	...
        	double valore_borsa_pend_min = 0;
        	
        	if (uni_r_parmas_valore == null){
        		valore_borsa_pend_min = 0.0;
        	}else{
        		valore_borsa_pend_min = new Double((String)(uni_r_parmas_valore.getElement(1, 2))).doubleValue();
        	}
        	
        	return valore_borsa_pend_min;
