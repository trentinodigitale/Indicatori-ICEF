...
public abstract class QDatiDomanda extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			// 		   						  1         	   		  2	    	   		       3   		 	  		  4						5
			sql.append("SELECT IVS_unita.iscritto_dal, IVS_unita.riduzione65_dal, IVS_unita.cancellato_dal, Soggetti.data_nascita, Soggetti.ID_soggetto "); 
			...
			//						10							11							12									13									14
			sql.append("Doc.data_presentazione, Domande.id_ente_erogatore,IVS_Aziende_Agricole.valutato_apapi,IVS_Aziende_Agricole.contributo_calcolato_apapi, Domande.escludi_ufficio ");
