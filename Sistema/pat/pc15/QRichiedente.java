...
public abstract class QRichiedente extends ElainNode {
	...
	int pc_IDServizio = 9390;
	//vedi mese di gennaio nella tabella PNS_tp_riferimenti per il servizio in questione SELECT    ID_riferimento	FROM  PNS_tp_riferimenti	WHERE (ID_servizio = 9390) AND (riferimento = N'gennaio')
	int pc_IDRiferimento_gennaio = 309; 
	
	//SELECT * FROM R_Relazioni_parentela	WHERE (ID_servizio = 9380) AND (parentela IN (N'FE', 'FR', 'FC', 'AR', 'AC')) 
	String pc_lista_IDRelazioneParentela_figli = "26944, 26945, 26946, 26947, 26948"; //vedi tabella R_Relazioni_parentela 
	...
	String pc_lista_IDRelazioneParentela_parenti = "26949, 26950, 26951, 26952"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	
	//SELECT * FROM R_Relazioni_parentela	WHERE        (ID_servizio = 9390) AND (parentela = N'Richiedente')
	String pc_lista_IDRelazioneParentela_richiedente = "26940"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
