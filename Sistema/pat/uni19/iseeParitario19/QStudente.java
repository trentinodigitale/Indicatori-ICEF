package c_elab.pat.uni19.iseeParitario19;
...
public abstract class QStudente extends ElainNode {
    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
            ...
            sql.append("SELECT  ID_domanda, ISEE, ISP, VSE ");
            sql.append(" FROM   UNI_Isee_parificato");
            sql.append(" WHERE  UNI_Isee_parificato.ID_domanda = ");
