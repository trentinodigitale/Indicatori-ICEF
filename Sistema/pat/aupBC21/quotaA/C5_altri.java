...
import c_elab.pat.icef21.DefComponentiDich;
...
public class C5_altri extends DefComponentiDich {
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
            ...
            //      				  1					2  					3			
            sql.append("SELECT causa_emergenza, imm_imp_mese_prec, imm_imp_due_mesi_prec ");
			...
			if("1".equals(causaEmergenza)) {
				sql = new StringBuffer();
				sql.append("select sum(consistenza) from aup_patrimonio_finanziario where semestre = 1 and id_domanda = ");
				sql.append(IDdomanda);
				try {
