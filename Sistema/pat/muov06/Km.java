 ...
 * @author g_barbieri
 */
public class Km extends ElainNode {

	private static long ID_servizio_con_riduz = 8000;
	private static String ID_parentela_beneficiario_con_riduz = "131";
	private static String anno = "2006";
	...
	public void init(RunawayData dataTransfer) {
		...
		if ( servizio == ID_servizio_con_riduz ) {
			...
			//                                   1                                    2
			sql.append(
				"SELECT MUOVERSI_Richiedente.km_richiesti, MUOVERSI_km_assegnati.km_assegnati ");
