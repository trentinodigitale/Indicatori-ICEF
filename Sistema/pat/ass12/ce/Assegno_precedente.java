...
package c_elab.pat.ass12.ce; 

import it.clesius.apps2core.ElainNode;
import it.clesius.db.sql.RunawayData;
import it.clesius.evolservlet.icef.anf.PassaValoriANF12;
...
public class Assegno_precedente extends ElainNode {
	...
	private static String anno_erogazione="2010";
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append(PassaValoriANF12.getID_dichiarazioni(IDdomanda));
