...
public abstract class QRichiedente extends ElainNode {
	...
	//CAMBIAMI: va cambiata ogni anno - fatto 1/8/14
	int pc_IDServizio = 9370;
	int pc_IDRiferimento_gennaio = 196; //vedi mese di gennaio nella tabella PNS_tp_riferimenti per il servizio in questione
	String pc_lista_IDRelazioneParentela_figli = "13824, 13825, 13826, 13827, 13828"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_parenti = "13829, 13830, 13831, 13832"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_richiedente = "13820"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
