...
public abstract class QCorso extends ElainNode {
    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
            ...
            sql.append(" WHERE UNI_R_Corsi_Laurea_2.ID_servizio=1040 AND UNI_Dati.parametro = 'TIPO_CORSO' AND UNI_Dati_Imm.parametro = 'ANNO_PRIMA_IMM' AND UNI_Dati.ID_domanda = ");
