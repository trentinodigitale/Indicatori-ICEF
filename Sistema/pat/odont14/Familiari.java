...
public class Familiari extends ElainNode {
    ...
    public void init(RunawayData dataTransfer) {
        ...
        //                  1               2                3                   4
        doQuery(
        "SELECT Soggetti.cognome, Soggetti.nome, Soggetti.data_nascita, Soggetti.codice_fiscale, familiari.residenza_storica "
        + "FROM ((Familiari INNER JOIN Dich_icef ON Familiari.ID_dichiarazione = Dich_icef.ID_dichiarazione) "
