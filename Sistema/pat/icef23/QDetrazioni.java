	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			if(!IDdomanda.startsWith("*"))
			{
				...
				//                             1                                    2                     3						4							 5							6
				sql.append(
					"SELECT Detrazioni.ID_tp_detrazione, R_Relazioni_parentela.peso_reddito, Detrazioni.importo, Detrazioni.ID_dichiarazione, Detrazioni.cointestatari, Detrazioni.contributo ");
				...
				if(componentiPV != null && componentiPV.length()>0){
					sqlComponenti.append(" AND Familiari.ID_dichiarazione in ");
					sqlComponenti.append(componentiPV);
				}
			...
			else
			{
				...
				//              			1                		2            3						4					  5				6
				sql.append("SELECT     ID_tp_detrazione, 100 AS peso_reddito, importo, Detrazioni.ID_dichiarazione, 1 as cointestatari, contributo ");
			...
			sql.append(" order by importo desc");
