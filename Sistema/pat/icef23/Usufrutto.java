...
public class Usufrutto {
	...
	*/
	...
	private static final float[][] aContratto21 = { // ordine crescente!!!
			// tasso 0,01% dal 1/1/2021
			{ 1.0f,    2.0f,    3.0f,     4.0f,     5.0f,     6.0f,     7.0f,     8.0f,     9.0f,     10.0f,    12.0f,    15.0f,    20.0f,    25.0f,    30.0f,    35.0f,    40.0f,    50.0f   },
			{ 0.0001f, 0.0002f, 0.0003f,  0.0004f,  0.0005f,  0.0006f,  0.0007f,  0.0008f,  0.0009f,  0.0010f, 0.0012f,  0.0015f,  0.0020f,  0.0025f,  0.00030f, 0.0035f,  0.0040f,  0.00050f },
		};
	...
	*/
	...
	private static final float[][] aVita21 = { // ordine crescente!!!!
			{ 20.0f, 30.0f, 40.0f, 45.0f, 50.0f, 53.0f, 56.0f, 60.0f, 63.0f, 66.0f, 69.0f, 72.0f, 75.0f, 78.0f, 82.0f, 86.0f, 92.0f, 99.0f },
			{ 0.95f, 0.9f,  0.85f, 0.8f,  0.75f, 0.7f,  0.65f, 0.6f,  0.55f, 0.5f,  0.45f, 0.4f,  0.35f, 0.3f,  0.25f, 0.2f,  0.15f, 0.1f  },
	};	 	
	...
	*/
	public static float getPercUsuf_aVita(int eta, int yearRif) {
		...
		// a partire dal 2021		
			...
			if (eta <= aVita21[0][aVita21[0].length - 1]) {
				while (eta > (aVita21[0][i])) {
					i++;
				}
			} else {
				i = aVita21[0].length - 1;
			}
			return aVita21[1][i];			
		}
	}
	...
	public static float getPercUsuf_aTermine(int durata, int yearRif) {
		...
		// a partire dal 2021				
			...
			if (durata <= aContratto21[0][aContratto21[0].length - 1]) {
				while (durata > aContratto21[0][i]) {
					i++;
				}
			} else {
				i = aContratto21[0].length - 1;
			}
			return aContratto21[1][i];			
		}
	}
}