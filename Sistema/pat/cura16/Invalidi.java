package c_elab.pat.cura16;
//CAMBIAMI DA CAMBIARE ANNUALMETNE icef15
import it.clesius.clesius.util.Sys;
import c_elab.pat.icef15.QParticolarita;

public class Invalidi
  extends QParticolarita
{
	//CAMBIAMI DA CAMBIARE ANNUALMENTE
  String assist2 = "15727";
  double QBI = 5400.0;
  double DMI = 0.0;
  ...
  public double getValue()
  {
    ...
    try
    {
      for (int i = 1; i <= this.records.getRows(); i++) {
        if (!this.records.getString(i, 7).equals(this.assist2))
        {
