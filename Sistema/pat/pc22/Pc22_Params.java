 ...
 */
	...
	public static int pc_IDServizio_casalinghe 	= 9399;
//	public static int pc_IDServizio_disoccupati = 9397;
	...
	public static int pc_casa_IDRiferimento_gennaio = 23201; //CAMBIAMI - DA FARE

	public static String pc_casa_lista_IDRelazioneParentela_figli = "33944, 33945, 33946, 33947, 33948"; //vedi tabella R_Relazioni_parentela 
	public static String pc_casa_lista_IDRelazioneParentela_parenti = "33949, 33950, 33951, 33952"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	public static String pc_casa_lista_IDRelazioneParentela_richiedente = "33940"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
