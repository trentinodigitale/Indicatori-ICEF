    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			try {
				...
				if(pc_IDServizio==Pc22_Params.pc_IDServizio_casalinghe){
					pc_IDRiferimento_gennaio = Pc22_Params.pc_casa_IDRiferimento_gennaio; 
					pc_lista_IDRelazioneParentela_figli = Pc22_Params.pc_casa_lista_IDRelazioneParentela_figli; 
					pc_lista_IDRelazioneParentela_parenti = Pc22_Params.pc_casa_lista_IDRelazioneParentela_parenti;
					pc_lista_IDRelazioneParentela_richiedente = Pc22_Params.pc_casa_lista_IDRelazioneParentela_richiedente;
				
				}
//				else if(pc_IDServizio==Pc18_Params.pc_IDServizio_disoccupati){
//					pc_IDRiferimento_gennaio = Pc18_Params.pc_dis_IDRiferimento_gennaio; 
//					pc_lista_IDRelazioneParentela_figli = Pc18_Params.pc_dis_lista_IDRelazioneParentela_figli;
//					pc_lista_IDRelazioneParentela_parenti = Pc18_Params.pc_dis_lista_IDRelazioneParentela_parenti;
//					pc_lista_IDRelazioneParentela_richiedente = Pc18_Params.pc_dis_lista_IDRelazioneParentela_richiedente;
//				}
