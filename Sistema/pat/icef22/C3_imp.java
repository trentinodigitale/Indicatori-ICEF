...
public class C3_imp extends DefComponentiDich {
	...
	public void init(RunawayData dataTransfer) {
		...
		if(!IDdomanda.startsWith("*"))
		{
			...
			//                                      1                              2											3								4
			sql.append("SELECT R_Relazioni_parentela.peso_reddito, sum(Redditi_impresa.reddito_dichiarato) as reddito, Redditi_impresa.ID_dichiarazione,Familiari.id_tp_invalidita ");
			...
			sql.append(" GROUP BY Redditi_impresa.ID_tp_impresa, R_Relazioni_parentela.peso_reddito, Redditi_impresa.ID_dichiarazione,Familiari.id_tp_invalidita");
		}
		else
		{
