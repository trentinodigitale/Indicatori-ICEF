...
import c_elab.pat.du13.DU_Util;
import c_elab.pat.icef.util.ElabContext;
import c_elab.pat.icef.util.ElabSession;
import c_elab.pat.icef13.C1_aut;
import c_elab.pat.icef13.C1_dip;
import c_elab.pat.icef13.C1_pens;
import c_elab.pat.icef13.C2_agr;
import c_elab.pat.icef13.C3_imp;
import c_elab.pat.icef13.C4_part;
...
public abstract class QFamiglieNumerose extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			// 		   					1         	   		 2					3					   4							  5
			sql.append("SELECT FN_Dati.concepiti, Doc.data_presentazione, FN_Dati.resTAA, DU_Dati.escludi_ufficio_fnum, DU_dati.richiede_fnum ");
			...
			sql.append(IDdomanda);
			sql.append(") ");
			if(PassaValoriDu2013.getID_dichiarazioni(IDdomanda)!=null)
			{
				sql.append(" AND Familiari.ID_dichiarazione IN ");
				sql.append(PassaValoriDu2013.getID_dichiarazioni(IDdomanda));
			}
