...
public abstract class QRichiedente extends ElainNode {
	...
	int pc_IDServizio = 9360;
	int pc_IDRiferimento_gennaio = 178; //vedi mese di gennaio nella tabella PNS_tp_riferimenti per il servizio in questione
	String pc_lista_IDRelazioneParentela_figli = "6379, 6380, 6381, 6382, 6383"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_parenti = "6384, 6385, 6386, 6387"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_richiedente = "6375"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
