...
public class QImmobiliare extends DefComponentiDich {
	...
	protected String getDefaultQuery()	{
		...
		sql.append("SELECT ABSOC_immobili_ceduti.ID_tp_cessione, 100 AS peso_patrimonio, ABSOC_immobili_ceduti.valore_ici, ABSOC_immobili_ceduti.ID_tp_cat_catastale, ABSOC_immobili_ceduti.ID_tp_diritto, ABSOC_immobili_ceduti.anni_usufrutto, ABSOC_immobili_ceduti.data_nascita_usufruttuario, Doc.data_presentazione, "+annoAC+" AS anno_produzione_patrimoni, 0 AS ID_dichiarazione, "+annoAC+" AS anno_produzione_redditi,  ABSOC_immobili_ceduti.ID_tp_immobile, ABSOC_immobili_ceduti.quota  ");
		sql.append("FROM Doc ");
		sql.append("INNER JOIN Domande ON Doc.ID = Domande.ID_domanda ");
		sql.append("INNER JOIN ABSOC_immobili_ceduti ON Domande.ID_domanda = ABSOC_immobili_ceduti.ID_domanda ");
		sql.append("WHERE (ABSOC_immobili_ceduti.ID_tp_uso_immobile = 'RES' OR ABSOC_immobili_ceduti.ID_tp_uso_immobile = 'ALT') ");
