...
//            sql.append(" AND STUD_R_tariffe.ID_luogo = '"+PassaValoriDu2017.getID_luogo(IDdomanda)+"'");
//            sql.append(" AND STUD_R_tariffe.ID_scuola = "+PassaValoriDu2017.getID_scuola(IDdomanda));
//            sql.append(" AND STUD_R_tariffe.ID_tp_scuola = "+PassaValoriDu2017.getID_tp_scuola(IDdomanda));
//            sql.append(" AND STUD_R_tariffe.ID_tp_beneficio = '"+PassaValoriDu2017.getID_tp_beneficio(IDdomanda)+"'");
//            sql.append("");
            
            Table tb=MemoryCache.getInstance().getMemoryCacheTable(this.getClass(),IDdomanda,
            		PassaValoriDu2017.getID_luogo(IDdomanda),
            		PassaValoriDu2017.getID_scuola(IDdomanda),
            		PassaValoriDu2017.getID_tp_scuola(IDdomanda),
            		PassaValoriDu2017.getID_tp_beneficio(IDdomanda));
            if(tb==null){
