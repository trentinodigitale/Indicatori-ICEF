...
public abstract class QRichiedente extends ElainNode {
	...
	int pv_IDServizio = 9220;
	int pv_IDRiferimento_1Trimestre = 59; //vedi 1 trimestre nella tabella PNS_tp_riferimenti per il servizio in questione
	String pv_lista_IDRelazioneParentela_figli = "1431, 1432, 1433, 1434, 1435"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pv_lista_IDRelazioneParentela_richiedente = "1427"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
