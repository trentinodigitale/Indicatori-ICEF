...
public abstract class QCorso extends ElainNode {
	...
	int id_servizio = 1037; //Attenzione, da modificare ogni anno
    ...
    public void init(RunawayData dataTransfer) {
    	...
    	ElabStaticSession session =  ElabStaticContext.getInstance().getSession( this.getClass().getName(), IDdomanda, "records" );
		...
		if (!session.isInitialized()) {
            ...
            sql.append(" WHERE UNI_R_Corsi_Laurea_2.ID_servizio="+id_servizio+" AND UNI_Dati.parametro = 'TIPO_CORSO' AND UNI_Dati_Imm.parametro = 'ANNO_PRIMA_IMM' AND UNI_Dati.ID_domanda = ");
    ...
    protected void reset() {
		ElabStaticContext.getInstance().resetSession( this.getClass().getName(), IDdomanda, "records" );
  }
