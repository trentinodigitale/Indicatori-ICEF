...
/**
 * CAMBIAMI PassaValoriDu2018 con PassaValoriDu2018
 */
import it.clesius.apps2core.ElainNode;
import it.clesius.apps2core.ricalcolo.client.memory.MemoryCache;
import it.clesius.db.sql.RunawayData;
import it.clesius.db.util.Table;
import it.clesius.evolservlet.icef.du.PassaValoriDu2018;
...
//            sql.append(" AND STUD_R_tariffe.ID_luogo = '"+PassaValoriDu2018.getID_luogo(IDdomanda)+"'");
//            sql.append(" AND STUD_R_tariffe.ID_scuola = "+PassaValoriDu2018.getID_scuola(IDdomanda));
//            sql.append(" AND STUD_R_tariffe.ID_tp_scuola = "+PassaValoriDu2018.getID_tp_scuola(IDdomanda));
//            sql.append(" AND STUD_R_tariffe.ID_tp_beneficio = '"+PassaValoriDu2018.getID_tp_beneficio(IDdomanda)+"'");
//            sql.append("");
            
            Table tb=MemoryCache.getInstance().getMemoryCacheTable(this.getClass(),IDdomanda,
            		PassaValoriDu2018.getID_luogo(IDdomanda),
            		PassaValoriDu2018.getID_scuola(IDdomanda),
            		PassaValoriDu2018.getID_tp_scuola(IDdomanda),
            		PassaValoriDu2018.getID_tp_beneficio(IDdomanda));
            if(tb==null){
