	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			if(!IDdomanda.startsWith("*"))
			{
				...
				//                             1                                    2                     3						4							 5
				sql.append(
					"SELECT Detrazioni.ID_tp_detrazione, R_Relazioni_parentela.peso_reddito, Detrazioni.importo, Detrazioni.ID_dichiarazione, Detrazioni.cointestatari ");
			...
			else
			{
				...
				//              			1                		2            3						4					  5
				sql.append("SELECT     ID_tp_detrazione, 100 AS peso_reddito, importo, Detrazioni.ID_dichiarazione, 1 as cointestatari ");
