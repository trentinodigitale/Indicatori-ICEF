 ...
 * @author g_barbieri
 */
public class Invalidi extends c_elab.pat.icef15.QParticolarita {
	//NB questa classe estende la classe standard icef13.QParticolarita
	
	//CAMBIAMI: va cambiata ogni anno
	private static Integer assistitoMag=14740;  
	private static Integer assistitoMin=14750;
