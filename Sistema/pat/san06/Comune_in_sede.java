...
public class Comune_in_sede extends ElainNode {
    ...
    public void init(RunawayData dataTransfer) {
        ...
        sql.append(
        "Domande ON SAN_Studenti.ID_domanda = Domande.ID_domanda INNER JOIN ");
        sql.append(
        "SAN_R_Comuni_in_sede ON SAN_Studenti.ID_anno_accademico = SAN_R_Comuni_in_sede.ID_anno_accademico AND ");
        sql.append(
        "Domande.ID_comune_residenza = SAN_R_Comuni_in_sede.ID_comune AND ");
        sql.append(
        "SAN_Studenti.ID_sede_corso = SAN_R_Comuni_in_sede.ID_sede_corso ");
