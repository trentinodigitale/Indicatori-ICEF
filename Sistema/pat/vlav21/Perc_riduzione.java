	...
	public double getValue() {
		...
		try {
			...
			for (int i = 1; i <=records.getRows(); i++){
				if (records.getInteger(i, 1) == Vlav21_Params.coniuge ||
						records.getInteger(i, 1) ==Vlav21_Params.convivente ||
						records.getInteger(i, 1) == Vlav21_Params.figlio)
					n_familiari++;
				else if (records.getInteger(i, 1) == Vlav21_Params.genitore)
					n_genitori++;
				else if (records.getInteger(i, 1) == Vlav21_Params.parente)
					n_parenti++;
			}
