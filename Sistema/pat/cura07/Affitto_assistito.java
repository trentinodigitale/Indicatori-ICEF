...
public class Affitto_assistito extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		sql.append("WHERE (Familiari.ID_relazione_parentela = 521 OR Familiari.ID_relazione_parentela = 539) AND Detrazioni.ID_tp_detrazione='CNL' AND Familiari.ID_domanda = ");
