    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
            ...
            for (int i = 1; i <= n_record; i++) {
	            ...
	            trimestre = super.getInteger(i,4) - 30; //TODO generalizzare per anni successivi!! vedi PNS_tp_riferimenti
...
//_________________________________ !!!!!!!!!!!!!!!	            
	            ...
	            if (decorrenza_volontaria.after(trentuno_dic_1995)) {
	                if (periodicita == 2)  //dip
	                	importo_colf = 26.0; //25.56;
	                else
	                	importo_colf = 94.12; //92.56;  //TODO
	            } else {
	                if (periodicita == 2)  //dip
	                	importo_colf = 21.72; //21.36;
	                else
	                	importo_colf = 94.12; //92.56; //TODO
	            }
	            ...
	            sql.append("(476, 477, 478, 479, 480)");             //TODO generalizzare
