...
public class Usufrutto {
	...
	*/
	...
	private static final float[][] aVita14 = { // ordine crescente!!!!
		{ 20.0f, 30.0f, 40.0f, 45.0f, 50.0f, 53.0f, 56.0f, 60.0f, 63.0f, 66.0f, 69.0f, 72.0f, 75.0f, 78.0f, 82.0f, 86.0f, 92.0f, 99.0f },
		{ 0.95f, 0.9f, 0.85f, 0.8f, 0.75f, 0.7f, 0.65f, 0.6f, 0.55f, 0.5f, 0.45f, 0.4f, 0.35f, 0.3f, 0.25f, 0.2f, 0.15f, 0.1f },
	};
	private static final float[][] aVita15 = { // ordine crescente!!!!
		{ 20.0f, 30.0f, 40.0f, 45.0f, 50.0f, 53.0f, 56.0f, 60.0f, 63.0f, 66.0f, 69.0f, 72.0f, 75.0f, 78.0f, 82.0f, 86.0f, 92.0f, 99.0f },
		{ 0.95f, 0.9f, 0.85f, 0.8f, 0.75f, 0.7f, 0.65f, 0.6f, 0.55f, 0.5f, 0.45f, 0.4f, 0.35f, 0.3f, 0.25f, 0.2f, 0.15f, 0.1f },
	};
	private static final float[][] aVita16 = { // ordine crescente!!!!
		{ 20.0f, 30.0f, 40.0f, 45.0f, 50.0f, 53.0f, 56.0f, 60.0f, 63.0f, 66.0f, 69.0f, 72.0f, 75.0f, 78.0f, 82.0f, 86.0f, 92.0f, 99.0f },
		{ 0.95f, 0.9f, 0.85f, 0.8f, 0.75f, 0.7f, 0.65f, 0.6f, 0.55f, 0.5f, 0.45f, 0.4f, 0.35f, 0.3f, 0.25f, 0.2f, 0.15f, 0.1f },
	};
	private static final float[][] aVita17 = { // ordine crescente!!!!
		{ 20.0f, 30.0f, 40.0f, 45.0f, 50.0f, 53.0f, 56.0f, 60.0f, 63.0f, 66.0f, 69.0f, 72.0f, 75.0f, 78.0f, 82.0f, 86.0f, 92.0f, 99.0f },
		{ 0.95f, 0.9f, 0.85f, 0.8f, 0.75f, 0.7f, 0.65f, 0.6f, 0.55f, 0.5f, 0.45f, 0.4f, 0.35f, 0.3f, 0.25f, 0.2f, 0.15f, 0.1f },
	};
	...
	*/
	public static float getPercUsuf_aVita(int eta, int yearRif) {
		...
		} else if (yearRif == 2012 || yearRif == 2013 || yearRif == 2014 || yearRif == 2015 || yearRif == 2016) {
		...
		// a partire dal 2017
			...
			if (eta <= aVita17[0][aVita17[0].length - 1]) {
				while (eta > (aVita17[0][i])) {
					i++;
				}
			} else {
				i = aVita17[0].length - 1;
			}
			//System.out.println("PercUsuf_aVita = " + aVita[1][i]);
			return aVita17[1][i];
		}
