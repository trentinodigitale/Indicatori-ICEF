...
public abstract class QRichiedente extends ElainNode {
	...
	int pc_IDServizio = 9330;
	int pc_IDRiferimento_gennaio = 108; //vedi mese di gennaio nella tabella PNS_tp_riferimenti per il servizio in questione
	String pc_lista_IDRelazioneParentela_figli = "5129, 5130, 5131, 5132, 5133"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_parenti = "5134, 5135, 5136, 5137"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
	String pc_lista_IDRelazioneParentela_richiedente = "5125"; //vedi tabella r_relazione_parentela per il servizio in questione, formato "id1, id2, id3, ..."
