...
public abstract class QRichiedente extends ElainNode {
    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
             ...
             *  periodo_di_disoccupazione tabella PNS_tp_periodi
             *  id_riferimento 1 trimestre tabella PNS_tp_riferimenti
             */
            int periodo_di_disoccupazione=40;
			int id_riferimento_1_trimestre=121;
            ...
            trimestre = super.getInteger(1,4) - id_riferimento_1_trimestre + 1; //TODO generalizzare per anni successivi!! vedi PNS_tp_riferimenti
           ...
           try {
            ...
            for (int i = 1; i <= records.getRows(); i++) {
	            ...
	            //TODO sistemare per servizi anni successivi al 2006    11
            	//if ( super.getInteger(i,1) == 1 || super.getInteger(i,1) == 8 ) { // disoccupazione
            	if ( super.getInteger(i,1) == periodo_di_disoccupazione ) { // disoccupazione
