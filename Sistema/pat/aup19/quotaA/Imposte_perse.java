	...
	public double getValue() {
		...
		try {
			for (int i = 1; i <= records.getRows(); i++)
			{
				...
				boolean quadroB_3_1 = records.getBoolean(i, 4) || records.getBoolean(i, 5) || records.getBoolean(i, 6) || records.getBoolean(i, 12);   //cessaz_lav_dip_indeter, cessaz_lav_dip_det, sosp_lav_dip_det, lavoratore stagionale
