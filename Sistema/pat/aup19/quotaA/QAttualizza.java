...
public abstract class QAttualizza extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			//									           10								               11									   12													13														14
			sql.append("AUP_familiari_attualizzata.lav_imp_mese_prec, AUP_familiari_attualizzata.lav_imp_due_mesi_prec,  coalesce(AUP_familiari_attualizzata.lavoratore_stagionale, 0), AUP_familiari_attualizzata.lav_imp_mese_prec_lav_stag, AUP_familiari_attualizzata.lav_imp_due_mesi_prec_lav_stag ");
