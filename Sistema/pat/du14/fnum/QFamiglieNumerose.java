...
/***************************************************************************************************/
import c_elab.pat.du14.DU_Util;
import c_elab.pat.icef14.C1_aut;
import c_elab.pat.icef14.C1_dip;
import c_elab.pat.icef14.C1_pens;
import c_elab.pat.icef14.C2_agr;
import c_elab.pat.icef14.C3_imp;
import c_elab.pat.icef14.C4_part;
/***************************************************************************************************/
/*** CAMBIAMI - NOTA BENE - VA CAMBIATA OGNI ANNO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!***/
/***************************************************************************************************/
...
public abstract class QFamiglieNumerose extends ElainNode {
	...
	public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			sql.append(IDdomanda);
			sql.append(") ");
			if(PassaValoriDu2014.getID_dichiarazioni(IDdomanda)!=null)
			{
				sql.append(" AND Familiari.ID_dichiarazione IN ");
				sql.append(PassaValoriDu2014.getID_dichiarazioni(IDdomanda));
			}
