    ...
    public void init(RunawayData dataTransfer) {
		...
		if (!session.isInitialized()) {
			...
			try {
				...
				if(pv_IDServizio==Pv19_Params.pv_IDServizio_casalinghe){
					pv_IDRiferimento_1Trimestre = Pv19_Params.pv_casa_IDRiferimento_1Trimestre; 
					pv_lista_IDRelazioneParentela_figli = Pv19_Params.pv_casa_lista_IDRelazioneParentela_figli;
					pv_lista_IDRelazioneParentela_richiedente = Pv19_Params.pv_casa_lista_IDRelazioneParentela_richiedente; 
				}else{
					pv_IDRiferimento_1Trimestre = Pv19_Params.pv_dis_IDRiferimento_1Trimestre; 
					pv_lista_IDRelazioneParentela_figli = Pv19_Params.pv_dis_lista_IDRelazioneParentela_figli;
					pv_lista_IDRelazioneParentela_richiedente = Pv19_Params.pv_dis_lista_IDRelazioneParentela_richiedente;
				}
            ...
            for (int k = 1; k <= n_anni; k++) {
            	...
            	for (int i = 1; i <= n_record; i++) {
            		...
            		if(pv_IDServizio==Pv19_Params.pv_IDServizio_disoccupati){
